...
router.get("/add-product", (req, res, next) => {
  ...
  res.sendFile(path.join(rootDir, "views", "add-product.html")); //__dirname is global path to node js folder,'../'is one level up,views is folder name, add-product is file name to load in this path
});
