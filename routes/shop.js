...
router.get("/", (req, res, next) => {
  ...
  res.sendFile(path.join(rootDir, "views", "shop.html")); //send to shop.html file if "/" address is called, __dirname is global variable to access root folder of app.js
});
